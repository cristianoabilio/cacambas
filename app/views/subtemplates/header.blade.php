<!--  <div id="wrapper"> -->
    <div class="navbar navbar-default navbar-principal getFixed">
     ...
     <div class="col-md-4">
        <h4>Caminhoes
          <button type="button" class="btn btn-principal btn-sm  btn-modal" data-toggle="modal" data-target="#myModal">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
          <button type="button" class="btn btn-success btn-sm">
           <span class="fa fa-plus"></span> Locação
         </button>
        </li>
        <li class="active">
        ...
        <li class="no-border">
          <a href="#" class="tTip" data-placement="bottom" data-toggle="tooltip" title="Sair"><i class="fa fa-sign-out fa-2x"></i></a>
        </li>
      </ul>
     </div>
    </div> <!-- fim navbar-->