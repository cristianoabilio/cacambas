...
<body>
	<div class="container">
		...
		{[ Form::model($caminhao, array('route' => array('empresa.caminhao.update', $id,$empresa_id), 'method' => 'PUT')) ]}
		<div class="row">
			<div class="col-sm-2">
		...
		{[Form::close()]}
		<br>
		{[ Form::model($caminhao, array('route' => array('empresa.caminhao.destroy', $empresa_id,$id), 'method' => 'DELETE')) ]}
