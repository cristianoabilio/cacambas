...
<body>
	you cannot create a resumoempresa cliente on this view.
	You must choose first a "empresa" and then add this resumoempresa
	<div class="container hide">
		<h1>New resumoempresacliente</h1>
		{[Form::open( array('url'=>URL::to('resumoempresacliente')) ) ]}
		<div class="row">
			<div class="col-sm-2">
				cliente_id
				<br>
