...
class EstadoCidadeBairroEnderecobaseController extends \BaseController {
	...
	public function visible () {
		...
		;
		return View::make('tempviews.EstadoCidadeBairroEnderecobase.index',$data);
	}
	...
	{
		return View::make('tempviews.EstadoCidadeBairroEnderecobase.create');
	}
	...
	public function showvisible ($id) {
		...
		try {
			...
			;
			return View::make('tempviews.EstadoCidadeBairroEnderecobase.show',$data);
	...
	public function edit($id)
	{
		...
		try {
			...
			;
			return View::make('tempviews.EstadoCidadeBairroEnderecobase.edit',$data);
